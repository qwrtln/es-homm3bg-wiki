...
| Freelancer's Guild | 4 :gold:<br>2 :building_materials:<br>1 :valuables: | Each time you win against [Unidades Neutrales](../units/index.md), gain 1 :gold:. When **Reinforcing** or **Recruiting** you can use :building_materials: and :valuables: like :gold:. |
...
- :bronze: [Trasgos](../units/goblins.md)
- :bronze: [Jinetes Lupinos](../units/wolf_raiders.md)
- :bronze: [Orcos](../units/orcs.md)
- :silver: [Ogros](../units/ogres.md)
- :silver: [Aves de Trueno](../units/thunderbirds.md)
- :golden: [Cíclopes](../units/cyclops.md)
