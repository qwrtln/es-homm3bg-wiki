...
![Sombrero del Encantador](../assets/artifacts_relic-spellbinders_hat.webp){ width="340" align=right }
___
...
- [^1] Con el segundo efecto, cualquier carta puede eliminarse junto con el Sombrero del Encantador.
