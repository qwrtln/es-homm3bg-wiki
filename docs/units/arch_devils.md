...
=== "Pocos"
    ...
    <figure markdown="span">
        ![Unos Pocos Archidiablos](../assets/units-inferno-golden-arch_devils-few.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Archidiablos](../assets/units-inferno-golden-arch_devils-pack.webp){ width="340" align=right }
    </figure>

=== "Neutral"

    <figure markdown="span">
        ![Archidiablos Neutrales](../assets/units-neutral-golden-arch_devils.webp){ width="340" align=right }
    </figure>
