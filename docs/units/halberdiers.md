...
=== "Pocos"
    ...
    <figure markdown="span">
        ![Pocos Alabarderos](../assets/units-castle-bronze-halberdiers-few.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Alabarderos](../assets/units-castle-bronze-halberdiers-pack.webp){ width="340" align=right }
    </figure>

=== "Neutral"

    <figure markdown="span">
        ![Alabarderos Neutrales](../assets/units-neutral-bronze-halberdiers.webp){ width="340" align=right }
    </figure>
