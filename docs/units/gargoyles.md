...
=== "Pocos"
    ...
    <figure markdown="span">
        ![Pocas Gárgolas](../assets/units-tower-bronze-gargoyles-few.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Gárgolas](../assets/units-tower-bronze-gargoyles-pack.webp){ width="340" align=right }
    </figure>

=== "Neutral"

    <figure markdown="span">
        ![Gárgolas Neutrales](../assets/units-neutral-bronze-gargoyles.webp){ width="340" align=right }
    </figure>
