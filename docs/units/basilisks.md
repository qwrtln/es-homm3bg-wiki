...
=== "Pocos"
    ...
    <figure markdown="span">
        ![Pocos Basiliscos](../assets/units-fortress-silver-basilisks-few.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Basiliscos](../assets/units-fortress-silver-basilisks-pack.webp){ width="340" align=right }
    </figure>

=== "Neutral"

    <figure markdown="span">
        ![Basiliscos Neutrales](../assets/units-neutral-silver-basilisks.webp){ width="340" align=right }
    </figure>
