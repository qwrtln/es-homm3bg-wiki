...
=== "Pocos"
    ...
    <figure markdown="span">
        ![Pocos Troglodytes](../assets/units-dungeon-bronze-troglodytes-few.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Troglodytes](../assets/units-dungeon-bronze-troglodytes-pack.webp){ width="340" align=right }
    </figure>
