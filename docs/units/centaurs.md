...
=== "Pocos"
    ...
    <figure markdown="span">
        ![Pocos Centauros](../assets/units-rampart-bronze-centaurs-few.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Centauros](../assets/units-rampart-bronze-centaurs-pack.webp){ width="340" align=right }
    </figure>

=== "Neutral"

    <figure markdown="span">
        ![Centauros Neutrales](../assets/units-neutral-bronze-centaurs.webp){ width="340" align=right }
    </figure>
