...
=== "Pocos"
    ...
    <figure markdown="span">
        ![Pocos Minotauros](../assets/units-dungeon-silver-minotaurs-few.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Minotauros](../assets/units-dungeon-silver-minotaurs-pack.webp){ width="340" align=right }
    </figure>
