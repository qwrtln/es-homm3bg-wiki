...
=== "Pocos"
    ...
    <figure markdown="span">
        ![Pocos Wraiths](../assets/units-necropolis-bronze-wraiths-few.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Wraiths](../assets/units-necropolis-bronze-wraiths-pack.webp){ width="340" align=right }
    </figure>
