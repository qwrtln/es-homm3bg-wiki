...
=== "Pocos"
    ...
    <figure markdown="span">
        ![Pocos Skeletons](../assets/units-necropolis-bronze-skeletons-few.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Skeletons](../assets/units-necropolis-bronze-skeletons-pack.webp){ width="340" align=right }
    </figure>
...
- **Neutral** - A [Necropolis](../towns/necropolis.md) player can reinforce their :bronze: unit during ongoing Combat. Any damage present on the Pocos side of the unit is transferred to the Pack side.
