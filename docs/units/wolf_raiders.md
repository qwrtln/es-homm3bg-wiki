...
=== "Pocos"
    ...
    <figure markdown="span">
        ![Pocos Jinetes Lupinos](../assets/units-blank-bronze.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Jinetes Lupinos](../assets/units-blank-bronze.webp){ width="340" align=right }
    </figure>
