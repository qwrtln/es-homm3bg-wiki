...
=== "Pocos"
    ...
    <figure markdown="span">
        ![Pocos Magogs](../assets/units-inferno-bronze-magogs-few.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Magogs](../assets/units-inferno-bronze-magogs-pack.webp){ width="340" align=right }
    </figure>
...
- **Manada and Neutral** - Should the Magogs attack a unit and there is only a friendly unit adjacent to their target, then the friendly unit will take the 1 :damage:.
