...
=== "Pocos"
    ...
    <figure markdown="span">
        ![Pocos Cerberos](../assets/units-inferno-bronze-cerberi-few.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Cerberos](../assets/units-inferno-bronze-cerberi-pack.webp){ width="340" align=right }
    </figure>

=== "Neutral"

    <figure markdown="span">
        ![Cerberos Neutral](../assets/units-neutral-bronze-cerberi.webp){ width="340" align=right }
    </figure>
