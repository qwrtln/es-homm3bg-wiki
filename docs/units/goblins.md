...
=== "Pocos"
    ...
    <figure markdown="span">
        ![Pocos Trasgos](../assets/units-blank-bronze.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Trasgos](../assets/units-blank-bronze.webp){ width="340" align=right }
    </figure>

=== "Neutral"

    <figure markdown="span">
        ![Trasgos Neutrales](../assets/units-blank-bronze.webp){ width="340" align=right }
    </figure>
