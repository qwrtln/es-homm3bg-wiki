...
=== "Pocos"
    ...
    <figure markdown="span">
        ![Pocas Hidras](../assets/units-fortress-golden-hydras-few.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Hidras](../assets/units-fortress-golden-hydras-pack.webp){ width="340" align=right }
    </figure>

=== "Neutral"

    <figure markdown="span">
        ![Hidras Neutrales](../assets/units-neutral-azure-hydras.webp){ width="340" align=right }
    </figure>
