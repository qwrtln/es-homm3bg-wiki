...
=== "Pocos"
    ...
    <figure markdown="span">
        ![Pocas Gorgonas](../assets/units-fortress-silver-gorgons-few.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Gorgonas](../assets/units-fortress-silver-gorgons-pack.webp){ width="340" align=right }
    </figure>

=== "Neutral"

    <figure markdown="span">
        ![Gorgonas Neutrales](../assets/units-neutral-silver-gorgons.webp){ width="340" align=right }
    </figure>
