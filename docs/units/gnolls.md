...
=== "Pocos"
    ...
    <figure markdown="span">
        ![Pocos Gnolls](../assets/units-fortress-bronze-gnolls-few.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Gnolls](../assets/units-fortress-bronze-gnolls-pack.webp){ width="340" align=right }
    </figure>

=== "Neutral"

    <figure markdown="span">
        ![Gnolls Neutrales](../assets/units-neutral-bronze-gnolls.webp){ width="340" align=right }
    </figure>
