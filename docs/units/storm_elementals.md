# Elementales de Tormenta

=== "Pocos"

    <figure markdown="span">
        ![Pocos Storm Elementals](../assets/units-blank-bronze.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Storm Elementals](../assets/units-blank-bronze.webp){ width="340" align=right }
    </figure>
