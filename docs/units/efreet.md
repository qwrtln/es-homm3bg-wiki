...
=== "Pocos"
    ...
    <figure markdown="span">
        ![Pocos Ifrits](../assets/units-inferno-golden-efreet-few.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Ifrits](../assets/units-inferno-golden-efreet-pack.webp){ width="340" align=right }
    </figure>

=== "Neutral"

    <figure markdown="span">
        ![Ifrits Neutrales](../assets/units-neutral-golden-efreet.webp){ width="340" align=right }
    </figure>
