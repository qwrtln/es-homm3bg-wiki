...
=== "Pocos"
    ...
    <figure markdown="span">
        ![Pocos Dendroides](../assets/units-rampart-silver-dendroids-few.webp){ width="340" align=right }
    </figure>

=== "Manada"

    <figure markdown="span">
        ![Manada de Dendroides](../assets/units-rampart-silver-dendroids-pack.webp){ width="340" align=right }
    </figure>

=== "Neutral"

    <figure markdown="span">
        ![Dendroides Neutrales](../assets/units-neutral-silver-dendroids.webp){ width="340" align=right }
    </figure>
