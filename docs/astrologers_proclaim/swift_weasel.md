...
![Comadreja Veloz](../assets/astrologers_proclaim-swift_weasel.webp){ width="475" align=right }
...
___
<p style="text-align: center;" markdown>Until the next Astrologer's round:<br><br>Once per turn, each player can reroll a [Tesoro die](../dice.md#treasure-die) or a [Resource die](../dice.md#resource-die).</p>
___
